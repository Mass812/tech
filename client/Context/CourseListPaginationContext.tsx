 ...
 type Action = | {type: 'LOADING_TRUE' } | {type: 'NAME', payload: string} | {  type: 'LOADING', payload: string}
 ...
 const CourseListPaginationContext : React.FC <CourseListPaginationContextProps> = ( {onPress}) => {
 ...
 <View>
   <TouchableOpacity style={{height: 100, width: 200, backgroundColor: 'red'}} onPress={onPress}/>
   <Text>
     {name}
   </Text>
 </View>
