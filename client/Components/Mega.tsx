...
const Mega: React.FC<MegaProps> = () => {
    ...
    let photoArray = [
        {photo: photoOne,  instructor: 'Amy Green', bulletPoints: '4 Weeks ∑ 20 Classes' ,id: 1, title: 'HIIT & Strength', buttonText:'View Program'}, 
        {photo:photoTwo,   instructor: 'Myranny Gupta', bulletPoints: 'Relieve Stress & Tension' ,id: 2, title: 'Focus Energy', buttonText:'Join Now'}, 
        {photo:photoThree, instructor: 'Rachele Lyle', bulletPoints: 'Meditative Moments' ,id: 3, title: 'Find Peace', buttonText:'Try Meditation'}
    ]
